...
type StringServiceClient interface {
	...
	ToUpper(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error)
}
...
func (c *stringServiceClient) ToUpper(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/stringService.StringService/ToUpper", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StringServiceServer interface {
	// 定义一个 RPC 方法 ToUpper，接收 StringMessage 请求，返回 StringMessage 响应
	ToUpper(context.Context, *StringMessage) (*StringMessage, error)
...
func (UnimplementedStringServiceServer) ToUpper(context.Context, *StringMessage) (*StringMessage, error) {
...
func _StringService_ToUpper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stringService.StringService/ToUpper",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StringServiceServer).ToUpper(ctx, req.(*StringMessage))
	}
